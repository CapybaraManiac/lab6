...
export async function getAllAbiturients(req, res) {
    try {
...
export async function getAbiturientById(req, res) {
    try {
...
export async function getAbiturientExams(req, res) {
    try {
        const id = req.params['id'];
        if (!id) {
            return res.status(400).json({ error: 'ID is required' });
...
export async function createAbiturient(req, res) {
    try {
...
export async function updateAbiturient(req, res) {
    try {
        const id = req.params['id'];
        if (!id) {
            return res.status(400).json({ error: 'ID is required' });
...
export async function deleteAbiturient(req, res) {
    try {
        const id = req.params['id'];
        if (!id) {
            return res.status(400).json({ error: 'ID is required' });
